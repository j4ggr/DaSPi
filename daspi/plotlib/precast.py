...
class ParameterRelevanceCharts(JointChart):
    ...
    ![Example of parameter relevance charts generated by the above code](https://raw.githubusercontent.com/j4ggr/DaSPi/main/docs/img/precast_parameter-relevance-charts_example.png)
    """
    __slots__ = ('lm')
...
class ResidualsCharts(JointChart):
    ...
    ![Example of residuals charts generated by the above code](https://raw.githubusercontent.com/j4ggr/DaSPi/main/docs/img/precast_residuals-charts_example.png)
    """
    __slots__ = ('lm')
...
class PairComparisonCharts(JointChart):
    ...
    ![Example of pairwise comparison charts generated by the above code](https://raw.githubusercontent.com/j4ggr/DaSPi/main/docs/img/precast_pair-comparison-charts_example.png)
    """
...
class BivariateUnivariateCharts(JointChart):
    ...
    ![Example of bivariate and univariate charts generated by the above code](https://raw.githubusercontent.com/j4ggr/DaSPi/main/docs/img/precast_bivariate-univariate-charts_example.png)
...
class PairwiseMatrixCharts(JointChart):
    ...
    ![Example of pairwise matrix charts generated by the above code](https://raw.githubusercontent.com/j4ggr/DaSPi/main/docs/img/precast_pairwise-matrix-charts_example.png)
    """
