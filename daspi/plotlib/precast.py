...
from .chart import check_label_order
...
from .plotter import GaussianKDEContour
...
class PairwiseMatrixCharts(JointChart):
    ...
    def plot(
        ...
        kw_diag : Dict[str, Any] | None, optional
            ...
            :obj:`{'visible_spines': 'target', 'hide_axis': 'feature'}`.
        ...
        """
        kw_diag = kw_diag or dict()
        kw_lower = kw_lower or dict()
        kw_upper = kw_upper or dict()
